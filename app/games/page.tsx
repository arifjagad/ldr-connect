...
const games = [
  ...
  },
  {
    ...
    tagline: "Seberapa baik kamu mengenalnya?",
    desc: "Jawab pertanyaan tentang pasanganmu dan buktikan seberapa dalam kalian saling mengenal satu sama lain.",
    badge: "SEGERA",
    available: false,
    cost: "Segera hadir",
    features: [
      "Pertanyaan personal & unik",
      "Sistem skor real-time",
      "Leaderboard pasangan",
      "Kategori spesial hari jadi",
    ],
    href: "#",
  },
];
